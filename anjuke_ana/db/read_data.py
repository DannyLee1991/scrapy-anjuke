...
def get_all_locate_a():
    ...
    :return:
    '''
    r = read_sql("select distinct LOCATE_A from anjuke_data")
...
def get_all_locate_b(locate_a):
    ...
    :return:
    '''
    r = read_sql("select distinct LOCATE_B from anjuke_data where LOCATE_A = \"{locate_a}\"".format(locate_a=locate_a))
